...
"""
# Accumulator
for count in range(count_of_rooms):
    deck.list()
    print(datastore["medical"][count]["room-number"], datastore["medical"][count]["use"], 
      datastore["medical"][count]["sq-ft"], datastore["medical"][count]["price"])
"""
